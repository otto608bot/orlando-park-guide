...
## Baseline (28d ending 2026-07-19 GSC / 2026-07-21 GA4)

| Metric | Baseline | 30d target | 90d target |
|---|---:|---:|---:|
| GSC clicks | 3 | 50 | 300 |
| GSC impressions | 1,399 | 3,000 | 10,000 |
| GSC CTR | 0.21% | 1.5% | 2.5%+ |
| GSC avg position | 38.9 | 30 | 20 |
...
- CTR lift on: [Epic Universe rides ranked](https://planyourpark.com/blog/epic-universe-rides-ranked-guide/) (483 impr), [parks hub](https://planyourpark.com/parks/) (334 impr), [packing list for kids](https://planyourpark.com/blog/disney-world-packing-list-kids/) (pos 6.5), and [Universal height requirements](https://planyourpark.com/blog/universal-orlando-height-requirements/) (pos 10.6) — **CTR v2 package dual-QA’d 2026-07-21, awaiting deploy**
- Preserve and amplify best converters: [Epic 1-day plan](https://planyourpark.com/blog/epic-universe-1-day-plan/) (2 clicks / 53 impr / 3.77% CTR) and [Magic Kingdom rides under 40 inches](https://planyourpark.com/blog/best-magic-kingdom-rides-kids-under-40-inches/) (1 / 31 / 3.23%)
- Reduce `/404` hits in GA (redirects drafted 2026-07-17)  
