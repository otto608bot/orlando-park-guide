...
if not TOKEN:
    raise RuntimeError("SANITY_API_TOKEN must be set before running this script.")
PROJECT = "hd7qwtcq"
...
body_mk = [
    ...
    {"_type": "block", "style": "normal", "listItem": "bullet", "children": [{"_type": "span", "text": "Dumbo the Flying Elephant – Classic spinning ride. Long queues—use Lightning Lane."}]},
...
posts = [
    ...
    },
    {
        ...
        "readTime": 11,
        "category": "disney-world",
        "tags": ["baby", "toddler", "planning", "kids", "lightning-lane", "stroller"],
        "body": body_baby
    },
    {
    ...
    },
    {
        ...
        "readTime": 10,
        "category": "disney-world",
        "tags": ["crowds", "strategy", "rope-drop", "touring-plan", "lightning-lane"],
        "body": body_crowds
    },
]
