export const samplePosts = {
  ...
  "orlando-closures-march-2026": {
    ...
    heroImage: { asset: { url: "https://planyourpark.com/epcot.jpeg" }, alt: "EPCOT" },
    author: { name: "Plan Your Park Team" },
    body: [{ _type: "block", style: "normal", children: [{ _type: "span", text: "Here's the latest on temporary closures and refurbishments across Orlando theme parks for March 2026." }] }]
  },
  "disney-world-guide": {
